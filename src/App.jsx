...
const QUESTION_BANK = [
  {
    q: "What is Gensyn building?",
    choices: [
      "A decentralized network for training AI models",
      "A social media app",
  ...
  {
    q: "What does 'RL' stand for in RL Swarm?",
    choices: [
      "Real Life",
  ...
  {
    q: "Which game does BlockAssist use to show how AI can learn from humans?",
    choices: ["Minecraft", "Fortnite", "PUBG", "Roblox"],
    answerIndex: 0,
  },
  {
    q: "What is the goal of Judge?",
    choices: [
      "To make AI art",
      "To train new chatbots",
      "To mine cryptocurrency",
      "To evaluate AI models in a fair and verifiable way",
    ],
    answerIndex: 3,
  },
  {
    q: "What type of system is Gensyn creating for AI training?",
    choices: [
      "Centralized system",
  ...
  {
    q: "Can anyone join the Gensyn network to contribute compute?",
    choices: ["Yes", "No"],
    answerIndex: 0,
  },
  {
    q: "Which Gensyn project helps AI models work together and learn from each other?",
    choices: ["Judge", "BlockAssist", "RL Swarm", "Verde"],
    answerIndex: 2,
  },
  {
    q: "What kind of data does BlockAssist learn from?",
    choices: [
      "Random numbers",
  ...
  {
    q: "What does the 'Judge' system use to make sure evaluations are trustworthy?",
    choices: [
  ...
  {
    q: "What kind of learning does RL Swarm use?",
    choices: [
      "Supervised learning",
      "Copy learning",
      "Reinforcement learning",
  ...
  {
    q: "What’s the main idea behind Gensyn’s mission?",
    choices: [
      "Make AI training open, fair, and decentralized",
      "Keep AI research private",
      "Focus only on chatbots",
      "Sell GPUs to users",
    ],
    answerIndex: 0,
  },
  {
    q: "What problem does Gensyn want to solve with decentralization?",
    choices: [
  ...
  {
    q: "What's one thing that makes the Gensyn Testnet special?",
    choices: [
      "Anyone can run it on their own device",
  ...
  {
    q: "What is Gensyn mainly focused on?",
    choices: [
  ...
  {
    q: "What kind of network is Gensyn building?",
    choices: [
      "A centralized cloud",
  ...
  {
    q: "What is 'Judge' used for in Gensyn?",
    choices: [
      "To create images",
      "To verify AI model performance",
  ...
  {
    q: "Which game does BlockAssist use to train AI helpers?",
    choices: ["Minecraft", "Fortnite", "PUBG", "Roblox"],
    answerIndex: 0,
  },
  {
    q: "What is the goal of RL Swarm?",
    choices: [
      "Let AI models work together and learn from each other",
      "Make games for robots",
      "Collect human data",
      "Simulate animals",
    ],
    answerIndex: 0,
  ...
  {
    q: "What type of people can join the Gensyn network?",
    choices: [
      "Only developers",
  ...
  {
    q: "What kind of learning does BlockAssist use?",
    choices: [
      "Assistance learning — learning from human actions",
  ...
  {
    q: "Which project helps verify machine learning tasks on untrusted hardware?",
    choices: ["Verde", "BlockAssist", "RL Swarm", "Judge"],
    answerIndex: 0,
  },
  {
    q: "True or False: You need an expensive GPU to join Gensyn.",
    choices: ["True", "False"],
    answerIndex: 1,
  },
  {
    q: "What makes Judge different from other AI evaluation tools?",
    choices: [
      "It uses cryptographic proofs for fairness",
      "It guesses answers randomly",
  ...
  {
    q: "What is BlockAssist’s goal inside Minecraft?",
    choices: [
      "To build random structures",
      "To make the game harder",
      "To test internet speed",
      "To assist players and learn from them",
    ],
    answerIndex: 3,
  },
  {
    q: "What does Gensyn want to make AI training more of?",
    choices: [
  ...
  {
    q: "What kind of computing power does Gensyn connect together?",
    choices: [
      "Global unused or underused compute devices",
  ...
  {
    q: "Which project is known for 'verifiable AI evaluation'?",
    choices: ["Judge", "RL Swarm", "BlockAssist", "Verde"],
    answerIndex: 0,
  },
  {
    q: "What does 'Swarm' mean in RL Swarm?",
    choices: [
      "A group of AI models working together",
      "A cluster of bees",
      "A single large GPU",
      "A fast blockchain",
    ],
  ...
  {
    q: "What is one big problem Gensyn is solving?",
    choices: [
      "Slow social media growth",
      "Lack of internet memes",
      "High cost of AI training",
      "Battery issues in phones",
    ],
    answerIndex: 2,
  },
  {
    q: "What does 'Assistance learning' mean?",
    choices: [
      "AI learns only from code",
      "AI learns by trial and error only",
      "AI learns by watching human actions",
      "AI learns through voting",
    ],
    answerIndex: 2,
  },
  {
    q: "What kind of environment does BlockAssist learn in?",
    choices: ["Space", "Underwater", "Minecraft world", "Office"],
    answerIndex: 2,
  },
  {
    q: "What is Gensyn’s approach to AI fairness?",
    choices: [
      "Transparent, reproducible, and verifiable results",
      "Random scoring",
      "Hidden evaluations",
      "Human-only reviews",
    ],
  ...
  {
    q: "What kind of system ensures AI models can be checked without trusting others?",
    choices: [
      "AI Playground",
      "Manual Review Panel",
      "Human Scoring Board",
  ...
  {
    q: "True or False: Gensyn is building open tools for everyone to use.",
    choices: ["False", "True"],
    answerIndex: 1,
  },
  {
    q: "What word best describes Gensyn’s vision for AI?",
    choices: ["Closed", "Exclusive", "Private","Collaborative",],
    answerIndex: 3,
  },
];
      ...
      <main className="max-w-5xl mx-auto px-4 pb-20">
        ...
        {step === 2 && quiz.length > 0 && (
          ...
          >
            ...
            <div className="p-5 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xs">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {quiz[current].choices.map((choice, cIdx) => (
                  <button
                    ...
                    className="text-left p-4 rounded-xl border transition border-white/10 bg-black/30 hover:bg-white/10"
                  >
                    {choice}
                  </button>
                ))}
